...
public class SalesByCountryActivityTest extends BaseTest {

    @Rule
    public IntentsTestRule<SalesByCountryActivity> activityRule = new IntentsTestRule<>(SalesByCountryActivity.class, true, false);
    ...
    public void shouldShowSummaryCardViewAndExploreMoreByDateAndCountryOptions() {
        ...
        onView(withId(R.id.sales_list_by_country)).check(matches(isDisplayed()));
    }
}
